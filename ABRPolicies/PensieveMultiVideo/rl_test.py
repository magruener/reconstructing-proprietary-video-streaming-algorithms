...
TRAIN_VIDEOS = './video_test/'
# log in format of time_stamp bit_rate buffer_size rebuffer_time chunk_size future_download_time reward
NN_MODEL = sys.argv[1]


# NN_MODEL = './models/nn_model_ep_300.ckpt'
