...
def main():
     if len(sys.argv) > 6:
        ...
        logfile = os.path.join(args.result_dir, "log/fast_mpc_server_{}.log".format(args.stream_id))
        ...
        logger = logging.getLogger("FAST MPC ABR SERVER {}".format(args.stream_id))
        ...
        run(port=args.port, log_file_path=args.trace_file)
