...
# NN_MODEL = None
NN_MODEL = './src/video_server/models/pretrain_linear_reward.ckpt'
    ...
    class Request_Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            if ( 'pastThroughput' in post_data ):
                ...
                logger.info("Past th here")
            else:
                rebuffer_time = float(post_data['RebufferTime'] -self.input_dict['last_total_rebuf'])
                
                logger.info("Rebuffer time {}".format(rebuffer_time))
